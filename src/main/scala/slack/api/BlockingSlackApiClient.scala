...
object BlockingSlackApiClient {
  ...
  def apply(endpoint: String,
    ...
    new BlockingSlackApiClient(endpoint, token, duration)
  }
  ...
  def exchangeOauthForToken(endpoint: String,
    ...
    Await.result(SlackApiClient.exchangeOauthForToken(endpoint,
                                                      clientId,
                                                      clientSecret,
                                                      code,
                                                      redirectUri),
...
class BlockingSlackApiClient(endpoint: String,
                             token: String,
                             duration: FiniteDuration = 5.seconds) {
  val client = new SlackApiClient(endpoint, token)
  ...
  def getChannelHistory(channelId: String,
      ...
      implicit system: ActorSystem): HistoryChunk = {
    resolve(
      client.getChannelHistory(channelId, latest, oldest, inclusive, count))
  }

  def getChannelInfo(channelId: String)(
      implicit system: ActorSystem): Channel = {
  ...
  def listChannels(excludeArchived: Int = 0)(
      implicit system: ActorSystem): Seq[Channel] = {
  ...
  /****  Chat Endpoints  ****/
  /**************************/
  def deleteChat(channelId: String, ts: String)(
      implicit system: ActorSystem): Boolean = {
  ...
  def postChatMessage(channelId: String,
      ...
      implicit system: ActorSystem): String = {
    resolve(
      client.postChatMessage(channelId,
                             text,
                             username,
                             asUser,
                             parse,
  ...
  def updateChatMessage(channelId: String, ts: String, text: String)(
      implicit system: ActorSystem): UpdateResponse = {
  ...
  def getFileInfo(
      fileId: String,
      count: Option[Int] = None,
      page: Option[Int] = None)(implicit system: ActorSystem): FileInfo = {
  ...
  def listFiles(userId: Option[String] = None,
      ...
      implicit system: ActorSystem): FilesResponse = {
  ...
  def createChildGroup(channelId: String)(
      implicit system: ActorSystem): Group = {
  ...
  def getGroupHistory(channelId: String,
      ...
      implicit system: ActorSystem): HistoryChunk = {
    resolve(
      client.getGroupHistory(channelId, latest, oldest, inclusive, count))
  }
  ...
  def listGroups(excludeArchived: Int = 0)(
      implicit system: ActorSystem): Seq[Group] = {
  ...
  def addReaction(emojiName: String,
      ...
      implicit system: ActorSystem): Boolean = {
    resolve(
      client.addReaction(emojiName, file, fileComment, channelId, timestamp))
  }

  def addReactionToMessage(
      emojiName: String,
      channelId: String,
      timestamp: String)(implicit system: ActorSystem): Boolean = {
  ...
  def getReactions(file: Option[String] = None,
      ...
      implicit system: ActorSystem): Seq[Reaction] = {
  ...
  def listReactionsForUser(userId: Option[String],
                           ...
                           count: Option[Int] = None,
                           page: Option[Int] = None)(
      implicit system: ActorSystem): ReactionsResponse = {
  ...
  def removeReaction(emojiName: String,
    ...
    resolve(
      client
        .removeReaction(emojiName, file, fileComment, channelId, timestamp))
  }
  ...
  def startRealTimeMessageSession()(
      implicit system: ActorSystem): RtmStartState = {
  ...
  def searchMessages(
      ...
      page: Option[Int] = None)(implicit system: ActorSystem): JsValue = {
    resolve(
      client.searchMessages(query, sort, sortDir, highlight, count, page))
  }
  ...
  def getTeamAccessLogs(count: Option[Int], page: Option[Int])(
      implicit system: ActorSystem): JsValue = {
